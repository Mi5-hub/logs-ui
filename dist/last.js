...
function DataGrid({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "mb-5 container_search"
  ...
  }, dataLogs.map((el, index) => /*#__PURE__*/React.createElement("tr", {
    className: "bg-white border-b  hover:bg-gray-50"
  }, /*#__PURE__*/React.createElement("td", {
    className: `py-${columnHeight}`
  }), columns.map(i => /*#__PURE__*/React.createElement("td", {
    className: `px-6 py-${columnHeight} ${i.field}`
  }, el[i.field])))))))), paginations ? /*#__PURE__*/React.createElement(Pagination, {
